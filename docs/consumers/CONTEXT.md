...
**Consumer**:
An application layer that uses the Gorchestra core. Consumers provide user experience, authorization, Secret protection mechanics, and runtime integration around Portfolio orchestration.
_Avoid_: Core
