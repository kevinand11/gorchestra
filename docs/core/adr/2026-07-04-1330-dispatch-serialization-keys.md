...
Superseded in part by [Dispatch coordination claims and Delivery work scheduling](./2026-07-04-2022-dispatch-coordination-claims-and-delivery-work.md), which generalizes Agent Run-only serialization keys into Core Dispatch Requests with Dispatch Coordination Claims.
