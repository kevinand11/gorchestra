...
- Portfolio-scoped Project and Secret UI/API routes use explicit Core command/query boundaries; add explicit Core operations before adding standalone Core routes for additional Portfolio facts.
