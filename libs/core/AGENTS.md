...
- Artifact creation provider calls and result writes belong in the `*-needs-artifact-creation` handlers; Artifact validation writes belong in the matching validation handlers and are dispatched through normal Delivery/Slice Work State handling.
